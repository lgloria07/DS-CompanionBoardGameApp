...
export default function RulesScreen() {
  ...
  const rules = [
    ...
    "No puedes usar a un mismo cazador para realizar la misma acción en una ronda (a menos que no tengas otra opción de turno)",
    ...
    "Si fallan su habilidad, los demonios pueden volver a intentar utilizar la misma habilidad 1 vez",
    ...
    "Para entrar a un combate, los cazadores solo pueden hacerlo por la casilla de tanque",
